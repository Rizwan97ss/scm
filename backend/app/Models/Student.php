...
#[Fillable([
    'school_id', 'admission_number', 'user_id', 'first_name', 'last_name', 'gender', 'date_of_birth',
    'blood_group', 'nationality', 'current_grade_level_id', 'current_section_id', 'current_department_id', 'academic_year_id',
...
class Student extends Model implements HasMedia
{
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logOnly(['first_name', 'last_name', 'status', 'current_grade_level_id', 'current_section_id', 'current_department_id'])
            ->logOnlyDirty()
            ->dontLogEmptyChanges();
    }
}
