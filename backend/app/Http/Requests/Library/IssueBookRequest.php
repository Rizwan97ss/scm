...
class IssueBookRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'student_id' => ['required_without:user_id', 'prohibits:user_id', 'nullable', Rule::exists('students', 'id')->where('school_id', $schoolId)],
            'user_id' => ['required_without:student_id', 'nullable', Rule::exists('users', 'id')->where('school_id', $schoolId)],
