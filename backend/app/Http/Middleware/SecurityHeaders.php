...
class SecurityHeaders
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // Belt-and-suspenders for a JSON API: nothing here is ever rendered as
        // HTML by a browser under normal use, but a reflected-content or
        // content-type-confusion bug in some future endpoint would otherwise
        // have no second line of defense. default-src 'none' + frame-ancestors
        // 'none' costs nothing today and closes that door regardless.
