...
class HostelTest extends TestCase
{
    ...
    public function test_hr_staff_cannot_view_another_schools_hostel_by_guessing_its_id(): void
    {
        ...
        $hostelB = Hostel::factory()->create();

        $response = $this->actingAsInSchool($hrA)->getJson("/api/v1/hostels/{$hostelB->id}");
