  ...
  return (
    <div>
      <PageHeader
        ...
        description="Fee heads used to build fee structures and invoice line items (Tuition, Transport, Library, ...)."
        actions={
          can('fees.create') && (
      ...
      <DataTable
        ...
        emptyDescription={can('fees.create') ? 'Create your first fee category to get started.' : undefined}
      />

      <Modal open={modalOpen} onOpenChange={setModalOpen} title={editing ? 'Edit Fee Category' : 'New Fee Category'}>
