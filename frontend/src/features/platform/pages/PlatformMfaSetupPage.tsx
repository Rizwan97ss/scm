...
export function PlatformMfaSetupPage() {
  ...
  return (
    <AuthLayout eyebrow={t('auth.mfaHeading')} title={t('auth.mfaSetupTitle')} description={t('platform.mfaSetupDescription')} wide>
      <p className="mb-6 text-sm text-muted-foreground">{t('auth.signedInAs', { email: platformUser?.email })}</p>
