...
export function DesignationsPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Designations"
        description="Job titles staff members hold (Math Teacher, Accountant, ...)."
        actions={
      ...
      <Modal open={modalOpen} onOpenChange={setModalOpen} title={editing ? 'Edit Designation' : 'New Designation'}>
